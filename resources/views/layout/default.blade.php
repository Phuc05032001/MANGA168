...
<html lang="th" prefix="og: https://ogp.me/ns#">
  <head>
    ...
    <meta name="theme-color" content="#ff6d38" />
    <meta name="msapplication-navbutton-color" content="#ff6d38" />
    <meta name="apple-mobile-web-app-capable" content="yes" />
    <meta name="apple-mobile-web-app-status-bar-style" content="#ff6d38" />
    <title>Manga168</title>
  ...
  >
    ...
    <style type="text/css" id="wp-custom-css">
      ...
      #footer {
        ...
        font-size: 13px;
        color: #fff;
        background-color: rgb(68 66 66 / 100%);
        position: static;
        width: 100%;
        bottom: 0;
      }
